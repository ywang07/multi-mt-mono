...
@register_model_architecture('multilingual_transformer', 'multilingual_transformer_vaswani_wmt_en_de_big')
...
@register_model_architecture('multilingual_transformer', 'multilingual_transformer_wmt_en_de_big')
def multilingual_transformer_wmt_en_de_big(args):
